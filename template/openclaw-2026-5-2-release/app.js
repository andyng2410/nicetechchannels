...
const slideScripts = [
  ...
  'Chốt lại: OpenClaw 2026.5.2 không phải bản vá nhỏ, nó là cuộc đại tu toàn diện cho hệ sinh thái plugin và channel. Follow escbase để cập nhật tech mới nhất.'
];
