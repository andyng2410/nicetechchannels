...
Đây là index mẫu cho NiceTechChannels slide visuals. Slide 1 phải copy từ canonical template folder tương ứng; các slide sau là mẫu code/visual để tham khảo, có thể copy, remix hoặc thay bằng scene sáng tạo hơn theo nội dung.

## Cách dùng

1. Copy deck mới từ `template/nicetechchannels-slide-starter`.
