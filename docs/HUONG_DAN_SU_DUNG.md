# Hướng dẫn sử dụng NiceTechChannels Template 3

Phiên bản: `83.v5.86`

Tài liệu này hướng dẫn từng bước để tạo một video slide 9:16 bằng NiceTechChannels Template Web UI: mở project bằng Antigravity IDE, dùng coding agent tạo project slide, kiểm tra mapping, tạo giọng đọc bằng ElevenLabs hoặc Edge TTS, render ra video cuối, rồi upload YouTube/Facebook nếu đã cấu hình.
...
Bạn cần một máy tính đã tải thư mục project NiceTechChannels Template. Phần còn lại cứ để script setup tự kiểm tra và cài những thứ cần thiết.
...
3. Mở Antigravity.
4. Chọn **Open Folder...** rồi mở thư mục `nicetechchannels_template`.
...
```bash
cd ~/Desktop/nicetechchannels_template
```
...
```powershell
cd C:\Users\Tin\Desktop\nicetechchannels_template
```
