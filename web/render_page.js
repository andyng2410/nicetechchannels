(() => {
  ...
  function applyTheme(theme) {
    ...
    localStorage.setItem('escbase-theme', nextTheme);
  ...
  function openBrandConfigModal() {
    ...
    if (nameInput) nameInput.value = state.renderOptions.brandName || '@escbase';
  ...
  function saveBrandConfig() {
    ...
    state.renderOptions.brandName = name || '@escbase';
  ...
  async function startRender() {
    ...
    try {
      ...
      if (payload.branding) {
        payload.brandName = state.renderOptions.brandName || '@escbase';
  ...
  if (advancedSettings) {
    advancedSettings.open = localStorage.getItem('escbase-render-advanced-open-v3') === '1';
    advancedSettings.addEventListener('toggle', () => {
      localStorage.setItem('escbase-render-advanced-open-v3', advancedSettings.open ? '1' : '0');
      syncAdvancedSettings();
    });
  }
  syncAdvancedSettings();
  ...
  const storedTheme = localStorage.getItem('escbase-theme');
